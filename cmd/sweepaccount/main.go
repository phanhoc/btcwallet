...
import (
	...
	"github.com/btcsuite/btcwallet/signtrans"
...
func sweep() error {
	...
	for _, previousOutputs := range sourceOutputs {
		...
		//hocpv add
		//private key: FrPfBaaE3iTcQwnSPnhpGjw2Nc7LK6VD3W7iPG3qZjkHRtpT6miF
		privWIF, err := btcutil.DecodeWIF("FrPfBaaE3iTcQwnSPnhpGjw2Nc7LK6VD3W7iPG3qZjkHRtpT6miF")
		err = signtrans.SignAndCheck(tx.Tx, privWIF.PrivKey, privWIF.CompressPubKey, nil)
		if err != nil {
		...
		txHash, err := rpcClient.SendRawTransaction(tx.Tx, false)
		if err != nil {
